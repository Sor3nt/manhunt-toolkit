...
class Ps2Test extends KernelTestCase
{
    ...
    public function testPackUnpack()
    {
        ...
        $resource = $resources->load('/Archive/Bin/Manhunt2/PS2/STRMANIM.BIN');


        $exportFolder = $resources->workDirectory . '/Archive/Bin/Manhunt2/PS2/export-test/';
        ...
        file_put_contents('test.bin', hex2bin($hex));
        exit;
